    ...
    model {
        ...
        enterprise "Clean Architecture AG" {
            ...
            archSystem = softwareSystem "ARCH system" "" {
                ...
                # containers
                blueprintApi = container "Blueprint API" "Provides client management endpoints" "Kotlin/Webflux" "api,microservice"
                service = container "Service" "Consumes Blueprint API"

                # infrastructure containers
                databaseServer = container "database-server" "Stores client information" "PostgreSQL" "infrastructure,database" {
