...
import edu.obya.blueprint.client.domain.model.TestClients
...
@Import(ClientR2dbcConfiguration::class, PostgresR2dbcDataSourceTestConfiguration::class)
...
internal class ClientRepositoryIT {
    ...
    fun `delete existing client`() {
        StepVerifier.create(repository.remove(TestClients.client1))
