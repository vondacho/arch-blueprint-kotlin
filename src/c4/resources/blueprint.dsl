    ...
    model {
        ...
        enterprise "Obya" {
            ...
            system = softwareSystem "blueprint-system" "A small system with one service and one database" "blueprint" {
                ...
                # containers
                api = container "blueprint-api" "Provides client management endpoints" "Kotlin/Webflux" "api,microservice"

                # infrastructure containers
                dbServer = container "database-server" "Manages database instances" "PostgreSQL" "infrastructure,database" {
                    dbInstance = component "database" "Stores clients data" "PostgreSQL" "infrastructure,schema"
                }
            }
            # internal persons
